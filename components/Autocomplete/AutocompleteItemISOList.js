...
const AutocompleteItemISOList = (props) => {
	console.log(props)
	...
	const handleInputReportMaster = (value, ReportMaster) => {
		...
		if (ReportMaster === "input") {
			...
			if (value !== "") {
				...
				// 	textsearch: value,
				// 	labroom: props.labroom.code,
				// };
				// axios
				// 	.post(ServiceUrl.urlResult + "ItemListMasterReport", reasReq)
				// 	.then((response) => {
				// 		console.log("sss", response.data);
				// 		setReportMasterItem(response.data.dataList);
				// 	})
				// 	.catch((error) => console.log(error));
				// props.datss.isoyn = "Y";
				setReportMasterItem(props.datas);
...
export default AutocompleteItemISOList;